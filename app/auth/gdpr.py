    ...
    try:
        async with open_db() as conn:
            async with conn.transaction():
                ...
                await conn.execute(
                    sql("queries/gdpr:delete_user_avatar"), (user_id,)
                )
                ...
                await conn.execute(
                    sql("queries/gdpr:delete_knowledge_chunks"), (user_id,)
                )
                await conn.execute(
                ...
                await conn.execute(
                    sql("queries/gdpr:delete_resource_labels"), (user_id,)
                )
                ...
                await conn.execute(
                    sql("queries/gdpr:delete_resource_executions"), (user_id,)
                )
                await conn.execute(
                ...
                await conn.execute(
                    sql("queries/gdpr:delete_legal_acceptances"), (user_id,)
                )
                await conn.execute(
                ...
                await conn.execute(
                    sql("queries/gdpr:delete_push_subscriptions"), (user_id,)
                )
                await conn.execute(
                    sql("queries/gdpr:delete_notifications"), (user_id,)
                )
                await conn.execute(
